...
import { createUserSchema } from '../schemas/userSchemas.js'; // Importa o esquema de validação de usuários
...
router.post('/adicionar',validate(createUserSchema),addNewUser) // Define a rota POST para adicionar um novo usuário
